...
<div class="content">
    ...
    <div class="info_auth">
        <div class="auth_info_text1">Найденные курсы:</div>
        <div class="user_input">
            <c:forEach var="course" items="${courses}">
                <a href="${course.link}" style="text-decoration: underline; text-decoration-color: #333366"><div class="contact_info_h1">${course.name}</div></a>
                <div class="cond_info12" style="width: 1000px">${course.short_desc}</div>
            </c:forEach>
        </div>
    </div>
    <div class="footer">
