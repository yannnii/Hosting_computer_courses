...
<div class="content">
    ...
    <div class="info_auth">
        <div class="auth_info_text1">Добавление курса</div>
        <form method="post">
            <div class="auth_input">
                <div class="course_text">
                    <div class="course_text1">Название:</div>
                    <input type="text" name="name" style="font-size: 14px; width: 1300px" required/>
                </div>
                <div class="course_text">
                    <div class="course_text1">Краткое описание:</div>
                    <input type="text" name="short_desc" style="font-size: 14px; width: 1300px" required/>
                </div>
                <div class="course_text">
                    <div class="course_text1">Полное описание:</div>
                    <input type="text" name="description" style="font-size: 14px; width: 1300px" required/>
                </div>
                <div class="course_text">
                    <div class="course_text1">Преподаватель:</div>
                    <input type="text" name="teacher" style="font-size: 14px; width: 1300px" required/>
                </div>
