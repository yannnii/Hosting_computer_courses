...
<div class="content">
    ...
    <div class="info_auth">
        <div class="auth_info_text1">Редактирование данных пользователя</div>
        <form method="post">
            <div class="auth_input">
                <input type="hidden" value="${user.id}" name="id" />
                <div class="course_text">
                    <div class="reg_text1">Имя:</div>
                    <input type="text" name="name" value="${user.name}" style="font-size: 14px; width: 1300px"/>
                </div>
                <div class="course_text">
                    <div class="reg_text1">Фамилия:</div>
                    <input type="text" name="surname" value="${user.surname}" style="font-size: 14px; width: 1300px"/>
                </div>
                <div class="course_text">
                    <div class="reg_text1">Логин:</div>
                    <input type="text" name="login" value="${user.login}" style="font-size: 14px; width: 1300px"/>
                </div>
                <div class="course_text">
                    <div class="reg_text1">Пароль:</div>
                    <input type="text" name="password" value="${user.password}" style="font-size: 14px; width: 1300px"/>
                </div>
                <div class="course_text">
                    <div class="reg_text1">Email:</div>
                    <input type="text" name="email" value="${user.email}" style="font-size: 14px; width: 1300px"/>
                </div>
                <div class="course_text">
                    <div class="reg_text1">Пол:</div>
                    <input type="text" name="gender" value="${user.gender}" style="font-size: 14px; width: 1300px"/>
                </div>
                <div class="course_text">
                    <div class="reg_text1">Роль:</div>
                    <input type="text" name="role" value="${user.userRole}" style="font-size: 14px; width: 1300px"/>
                </div>
                <div class="course_text">
                    <div class="reg_text1">Город:</div>
                    <input type="text" name="city" value="${user.city}" style="font-size: 14px; width: 1300px"/>
                </div>
                <div class="course_text">
                    <div class="reg_text1">Согласие:</div>
                    <input type="text" name="consent" value="${user.consent}" style="font-size: 14px; width: 1300px"/>
                </div>
