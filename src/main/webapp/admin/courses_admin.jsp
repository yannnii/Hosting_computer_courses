...
<div class="content">
    ...
    <div class="info_auth">
        <div class="auth_info_text1">Курсы</div>
            <div class="user_input">
                <table border=1 width="95%">
                    ...
                    <th>id</th><th>Название</th><th>Краткое описание</th><th>Полное описание</th><th>Преподаватель</th>
                    <tr>
                        <c:forEach var="course" items="${courses}">
                            <tr>
                                <th>${course.id}</th>
                                <th>${course.name}</th>
                                <th>${course.short_desc}</th>
                                <th>${course.description}</th>
                                <th>${course.teacher}</th>
                                <th><a href='<c:url value="/editCourse?id=${course.id}"/>'>
                                 <input id="edit_btn" type="submit" value="Редактировать">
                                </a>
                                <th><form method="post" action='<c:url value="/deleteCourse" />'>
        ...
        <div class="user_input">
            <a href='<c:url value="/addCourse"/>'>
                <input type="submit" value="Добавить курс" style="margin: 20px;">
            </a>
        </div>
    </div>
    <div class="footer">
