...
<div class="content">
    ...
    <div class="menu">
        ...
        <button><a href="index_admin.jsp"><b>Администратор</b></a></button>
    </div>
    <div class="info_auth">
        <div class="info11">
            <button class="admin_course"><a href="../coursesListServlet">Курсы</a></button>
        </div>
        <div class="info11">
            <button class="admin_course"><a href="../usersListServlet">Пользователи</a></button>
        </div>
        <div class="info11">
