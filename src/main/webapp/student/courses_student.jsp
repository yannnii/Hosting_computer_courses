    ...
    <div class="info_auth">
        ...
        <div class="user_input">
            <table border=1 width="95%">
                ...
                <th>id</th><th>Название курса</th><th>Email преподавателя</th>
                <tr>
                    <c:forEach var="course" items="${courses}">
                <tr>
                    <th>${course.id}</th>
                    <th>${course.course_name}</th>
                    <th>${course.teacher_email}</th>
                    <th><a href='<c:url value="/answerMessageServlet?from=${course.teacher_email}"/>'>
                        <input id="edit_btn" type="submit" value="Написать">
                    </a>
                </tr>
                </c:forEach>
                </tr>
