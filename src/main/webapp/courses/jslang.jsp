...
<head>
    ...
    <title>Программирование Java Script</title>
...
<div class="content">
    ...
    <div class="info">
        <div class="contact_info_h1">Программирование Java Script</div>
        <div class="course_main">
            <div class="course_main1">
                <div class="course_img">
                    <img src="../resources/img/js2.jpg" width="700" height="500" class="info_main_image" alt="">
                </div>
            </div>
            <div class="course_main1">
                <div class="cond_info12">JavaScript — один из самых популярных языков программирования. Его используют в веб-разработке для работы с фронтендом и бэкендом. Курсы в нашей школе — это путь от основ программирования на JavaScript до работы с популярными и востребованными инструментами, включая React, Redux, Webpack, Express.
                </div>
                <div class="info11">
                    <button class="course"><a href="../enrollCourse?course_name=Программирование Java Script&teacher_email=andreyivanov@yandex.ru">Записаться</a></button>
                </div>
            </div>
        </div>
    </div>
