...
<div class="content">
    ...
    <div class="info">
        <div class="contact_info_h1">Компьютерная графика</div>
        <div class="course_main">
            <div class="course_main1">
                <div class="course_img">
                    <img src="../resources/img/graphics2.jpg" width="700" height="500" class="info_main_image" alt="">
                </div>
            </div>
            <div class="course_main1">
                <div class="cond_info12">Основная цель курса – познакомить с предметной областью и дать навыки работы непосредственно с рассматриваемым материалом, а не изучить интерфейс известных графических редакторов. Есть множество понятий, программ и устройств, которыми мы пользуемся, но даже не представляем, как всё это работает. Попробуйте сходу ответить: что такое прозрачность, как работает фотоаппарат, что сжимается, то есть, чем в первую очередь жертвуют, в цифровой фотографии?
                </div>
                <div class="info11">
                    <button class="course"><a href="../enrollCourse?course_name=Компьютерная графика&teacher_email=sidorov2022@yandex.ru">Записаться</a></button>
                </div>
            </div>
        </div>
    </div>
