...
<head>
    ...
    <title>Программирование Java</title>
...
<div class="content">
    ...
    <div class="info">
        <div class="contact_info_h1">Программирование Java</div>
        <div class="course_main">
            <div class="course_main1">
                <div class="course_img">
                    <img src="../resources/img/java2.jpg" width="700" height="500" class="info_main_image" alt="">
                </div>
            </div>
            <div class="course_main1">
                <div class="cond_info12">Вы сможете приступить к обучению с нуля - без технического образования и опыта и освоить азы профессии. Вы сможете систематизировать свои знания, с углубленной подготовкой возобновить практику программирования на Java, прокачаться в технологиях языка и ускорить профессиональное развитие. Вы изучите новый язык и сможете  применять его в рабочих и личных проектах. Расширите компетенции еще одним профилем и решите, подходит ли вам эта специализация.
                </div>
                <div class="info11">
                    <button class="course"><a href="../enrollCourse?course_name=Программирование Java&teacher_email=ivanivanov@mail.ru">Записаться</a></button>
                </div>
            </div>
        </div>
    </div>
