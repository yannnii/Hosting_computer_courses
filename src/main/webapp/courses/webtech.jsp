...
<div class="content">
    ...
    <div class="info">
        <div class="contact_info_h1">Основы Web-технологий</div>
        <div class="course_main">
            <div class="course_main1">
                <div class="course_img">
                    <img src="../resources/img/web2.jpg" width="700" height="500" class="info_main_image" alt="">
                </div>
            </div>
            <div class="course_main1">
                <div class="cond_info12">Вы познакомитесь со стандартами Web 2.0, научитесь работать с макетами и форматировать код, освоите адаптивную верстку, а по итогу — сможете создавать быстрые и удобные сайты, которые точно понравятся пользователям. Вы поймёте назначение основных тегов HTML, сможете стилизовать и размещать элементы с помощью CSS и сверстаете свой первый макет. Вы расширите знания об HTML-разметке и CSS-технологиях, научитесь создавать интерактивные сайты на JavaScript и работать с системой контроля версий Git.
                </div>
                <div class="info11">
                    <button class="course"><a href="../enrollCourse?course_name=Основы Web-технологий&teacher_email=sidorov2022@yandex.ru">Записаться</a></button>
                </div>
            </div>
        </div>
    </div>
