...
<head>
    ...
    <title>Программирование PHP + базы данных MySQL</title>
...
<div class="content">
    ...
    <div class="info">
        <div class="contact_info_h1">Программирование PHP + базы данных MySQL</div>
        <div class="course_main">
            <div class="course_main1">
                <div class="course_img">
                    <img src="../resources/img/php2.png" width="700" height="500" class="info_main_image" alt="">
                </div>
            </div>
            <div class="course_main1">
                <div class="cond_info12">Первый уровень программирования на PHP создан для тех, кто мечтает научиться создавать сайты, но не знает с чего начать, так же он подойдет тем, кто уже может сделать простые вещи, но ещё не ориентируется в своём собственном коде. Благодаря простоте языка программирования первый уровень смогут освоить многие люди, единственное что от Вас требуется - внимательность и ответственность в обучении.
                </div>
                <div class="info11">
                    <button class="course"><a href="../enrollCourse?course_name=Программирование PHP + базы данных MySQL&teacher_email=alexpetrov@mail.ru">Записаться</a></button>
                </div>
            </div>
        </div>
    </div>
