...
<head>
    ...
    <title>Разработка приложений на Android</title>
...
<div class="content">
    ...
    <div class="info">
        <div class="contact_info_h1">Разработка приложений на Android</div>
        <div class="course_main">
            <div class="course_main1">
                <div class="course_img">
                    <img src="../resources/img/android2.jpg" width="700" height="500" class="info_main_image" alt="">
                </div>
            </div>
            <div class="course_main1">
                <div class="cond_info12">Освойте программирование на Java и Kotlin, изучите популярные библиотеки, научитесь разрабатывать мобильные приложения для Android. Углубите и структурируете знания Java и Kotlin. Начните нарабатывать опыт, выберите необходимые дополнительные навыки, которые пригодятся на работе, и освойте их в рамках этой программы. Получите знания по профессии Android-разработчик уровня Middle. Приятный бонус для новичков, системное обучение, структурированная программа курса, полный объём знаний и навыков для Андройд-разработчика.
                </div>
                <div class="info11">
                    <button class="course"><a href="../enrollCourse?course_name=Разработка приложений на Android&teacher_email=ivanivanov@mail.ru">Записаться</a></button>
                </div>
            </div>
        </div>
    </div>
