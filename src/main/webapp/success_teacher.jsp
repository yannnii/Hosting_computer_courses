...
<div class="content">
    ...
    <div class="info_auth">
        ...
        <div class="auth_info_text1">Дождитесь, пока администратор подтвердит корректность данных Вашей учетной записи</div>
        <div class="auth_info_text2"><a class="auth_a" href="index.jsp">На главную</a></div>
    </div>
    <div class="footer">
