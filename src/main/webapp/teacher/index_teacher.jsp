...
<div class="content">
    ...
    <div class="info_auth">
        <div class="info11">
            <button class="admin_course"><a href="allmessages_teacher.jsp">Сообщения</a></button>
        </div>
        <div class="info11">
            <button class="admin_course"><a href="../coursesListTeacherServlet">Мои курсы</a></button>
        </div>
        <div class="info11">
            <button class="admin_course"><a href="../logout">Выйти</a></button>
        </div>
    </div>
    <div class="footer">
