...
<div class="content">
    ...
    <div class="menu">
        ...
        <button><a href="index_teacher.jsp"><b>☺<%=login%></b></a></button>
    </div>
    <div class="info_auth">
        <div class="auth_info_text1">Сообщения</div>
        <div class="info11">
            <button class="admin_course"><a href='<c:url value="/newMessageServlet"/>'>Новое сообщение</a></button>
        </div>
        <div class="info11">
            <button class="admin_course"><a href='<c:url value="../messagesInListServlet"/>'>Входящие</a></button>
        </div>
        <div class="info11">
            <button class="admin_course"><a href='<c:url value="../messagesOutListServlet"/>'>Отправленные</a></button>
        </div>
    </div>
<div class="footer">
