...
<div class="content">
    ...
    <div class="info_auth">
        ...
        <form method="post" onsubmit="return captcha()">
            <div class="auth_input">
                <div class="course_text">
                    <div class="course_text1">От кого:</div>
                    <input type="text" name="from" value="<%=email%>" style="font-size: 14px; width: 1300px" required/>
                </div>
                <div class="course_text">
                    <div class="course_text1">Кому:</div>
                    <input type="text" name="whom" style="font-size: 14px; width: 1300px" required/>
                </div>
                <div class="course_text">
