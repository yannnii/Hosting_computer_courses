...
<head>
    ...
    <title>Отправленные сообщения</title>
...
<div class="content">
    ...
    <div class="menu">
        ...
        <button><a href="<%= request.getContextPath() %>/teacher/index_teacher.jsp"><b>☺<%=login%></b></a></button>
    </div>
    <div class="info_auth">
        <div class="auth_info_text1">Отправленные сообщения</div>
        <div class="user_input">
            <table border=1 width="95%">
                ...
                <th>id</th><th>Кому</th><th>Сообщение</th></th>
                <tr>
        ...
        <div class="user_input">
            <a href='<c:url value="/messagesInListServlet"/>'>
                <input type="submit" value="Входящие" style="margin: 20px;">
            </a>
        </div>
    </div>
    <div class="footer">
